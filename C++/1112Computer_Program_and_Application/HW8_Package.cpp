...
int main()
{
	string Paul[5] = { "Paul", "1st Street", "Taichung", "Taiwan", "402" },
	       John[5] = { "John", "4th Street", "Tainan", "Taiwan", "23" };
...
{
	setSenderName(sender[0])
		.setSenderAddress(sender[1])
		.setSenderCity(sender[2])
		.setSenderState(sender[3])
		.setSenderZIP(sender[4]);
	return *this;
}

Package &Package::setRecipient(string recipient[])
{
	setRecipientName(recipient[0])
		.setRecipientAddress(recipient[1])
		.setRecipientCity(recipient[2])
		.setRecipientState(recipient[3])
		.setRecipientZIP(recipient[4]);
	return *this;
}
