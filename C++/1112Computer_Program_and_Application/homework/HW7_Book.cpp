...
int main()
{
	...
	Cplusplus.update('T', "C++ How to Program")
		.update('A', "Paul Deitel")
		.update('P', 157.97f)
		.update('S', 1456);
	Calculus.update('T', "Essential Calculus")
		.update('A', "James Stewart")
		.update('P', 165)
		.update('S', 498);
	Economics.update('T', "Principle of Economics")
		.update('A', "Frank")
		.update('P', 210)
		.update('S', 943);
