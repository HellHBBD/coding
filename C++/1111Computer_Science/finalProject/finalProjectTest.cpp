...
void check_for2players(char g[], int a[], int length, int &A, int &B) { // 幾A幾B(雙人版)(跟單人板差在沒有鼓勵小羽)
...
void winner(int G1_count, int G2_count) { // 判斷雙人版贏家
...
void hint(int ansArray[], int digit, int hin) { // 提供提示
