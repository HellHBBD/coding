...
{ // 幾A幾B(單人版)
    ...
    if (A == length)//asdf
    {
        cout << "\n\033[3;36m𝕿𝖍𝖊 𝖘𝖊𝖈𝖗𝖊𝖙 𝖔𝖋 𝖘𝖚𝖈𝖈𝖊𝖘𝖘 𝖎𝖘 𝖈𝖔𝖓𝖘𝖙𝖆𝖓𝖈𝖞 𝖙𝖔 𝖕𝖚𝖗𝖕𝖔𝖘𝖊 ! 𝕯𝖔 𝖞𝖔𝖚 𝖜𝖆𝖓𝖙 𝖙𝖔 𝖈𝖍𝖆𝖑𝖑𝖊𝖓𝖌𝖊 𝖔𝖙𝖍𝖊𝖗 𝖌𝖆𝖒𝖊 𝖒𝖔𝖉𝖊 ? \033[0;0m\n" << endl;
    }
    else if (A == 1)
    {
        cout << "\n" 
        << "\033[3;36mℤ𝕖𝕣𝕠 𝕚𝕟 𝕪𝕠𝕦𝕣 𝕥𝕒𝕣𝕘𝕖𝕥，𝕒𝕟𝕕 𝕘𝕠 𝕗𝕠𝕣 𝕚𝕥 !\033[0;0m\n" << endl;
    }
    else if (A == 2)
    {
        cout << "\n"
             << "\033[3;36mғᴀɪʟᴜʀᴇ ɪs ᴛʜᴇ ᴍᴏᴛʜᴇʀ ᴏғ sᴜᴄᴄᴇss ! \033[0;0m\n" << endl;
    }
    else if (A == 3)
    {
        cout << "\n"
    ...
    {
        cout << "\n"
             << "\033[3;36mℬ𝒶𝒹 𝓉𝒾𝓂𝑒𝓈 𝓂𝒶𝓀𝑒 𝒶 𝑔𝑜𝑜𝒹 𝓂𝒶𝓃 ! \033[0;0m\n" << endl;
    }
    else if (A == 5)
    {
        cout << "\n"
             << "\033[3;36m𝒜𝒹𝓋𝑒𝓇𝓈𝒾𝓉𝓎 𝒾𝓈 𝓉𝒽𝑒 𝓂𝒾𝒹𝓌𝒾𝒻𝑒 𝑜𝒻 𝑔𝑒𝓃𝒾𝓊𝓈 ! \033[0;0m\n" << endl;
    }
    else if (A == 6)
    {
        cout << "\n"
             << "\033[3;36m𝔻𝕠𝕟'𝕥 𝕘𝕚𝕧𝕖 𝕦𝕡 𝕒𝕟𝕕 𝕕𝕠𝕟'𝕥 𝕘𝕚𝕧𝕖 𝕚𝕟 ! \033[0;0m\n" << endl;
    }
    else if (A == 7)
    {
        cout << "\n"
    ...
    {
        cout << "\n"
             << "\033[3;36mᴠɪᴄᴛᴏʀʏ ʙᴇʟᴏɴɢs ᴛᴏ ᴛʜᴇ ᴍᴏsᴛ ᴘᴇʀsᴇᴠᴇʀɪɴɢ ! \033[0;0m\n" << endl;
    }
    else if (A == 9 || (A == 1 && B == 2))
    {
        cout << "\n"
             << "\033[3;36m𝓐𝓵𝓵 𝓽𝓱𝓲𝓷𝓰𝓼 𝓬𝓸𝓶𝓮 𝓽𝓸 𝓽𝓱𝓸𝓼𝓮 𝔀𝓱𝓸 𝔀𝓪𝓲𝓽 ! \033[0;0m\n" << endl;
    }
}
...
{ // 提供提示
    ...
    if (hint == 1)
    {
        cout << "\033[33mThe " << randomDigit + 1 << " digit is " << ansArray[randomDigit] << " !\033[0m";
    }
}
...
int main()
{
    ...
    // 困難模式(2):猜英文
    if (mode == 2)
    { // 猜測英文，原則上相信玩家輸入四個小寫字母且不重複，其他function可以不用放進去。
        int digit = 4;
        int ansArray[digit];
        ...
        while (true)
        {
            ...
            if ((guessArray[0] == '-' && guessArray[1] == '1') || A == digit)
            {
                if (A == digit)
                {
                    ...
                    counter++;
                    time(&end); // 玩家猜對停止計時
                    cout << "\033[35m\n\nYou have spent \033[0m" << difftime(end, start) << "\033[35m sec(s) to guess the right answer";
                }
                break;
            }
    ...
    if (mode == 1 && player == 1)
    {
        ...
        else if (number_set == 2)
        { // 玩家自行輸入謎底
            while (true)
            {
                cout << "\033[34mPlease input " << digit << " digits:(input answer and split by space)\033[0m ";
        ...
        { // 確認玩家所猜測的數字不重複
            ...
            while (true)
            {
                ...
                cout << "\033[31mWrong Input! You cannot enter repeated numbers!\033[0m" << endl;
                cout << endl
                     << "guess ( or input -1 to quit ): \033[0m";
                cin >> guessArray;
            }
    ...
    else if (mode == 1 && player == 2)
    {
                ...
                { // 第一組猜
                    ...
                    if ((Group1_guessArray[0] == '-' && Group1_guessArray[1] == '1') || A == digit)
                    {
                        if (A == digit)
                        {
                            ...
                            cout << "\033[35m\n\nBattle over! Group 1 spent \033[0m" << difftime(end,start) << "\033[35m sec(s) to win the race!\n\033[0m" << endl;
                        }
                        break;
                    }
                    cout << "\033[32m" << A << "\033[0m"
                ...
                { // 第二組猜
                    ...
                    if ((Group2_guessArray[0] == '-' && Group2_guessArray[1] == '1') || A == digit)
                    {
                        if (A == digit)
                        {
                            ...
                            cout << "\033[35m\n\nBattle over! Group 2 spent \033[0m" << difftime(end,start) << "\033[35m sec(s) to win the race!\n\033[0m" << endl;
                        }
                        break;
                    }
                    cout << "\033[32m" << A << "\033[0m"
        ...
        { // 若是自行輸入謎底 則兩組互猜對方所出的謎題
            while (true)
            { // 第一組輸入謎底
                cout << "\033[34mGroup1 please input " << digit << " digits(split by space): \033[0m";
                for (int ans = 0; ans < digit; ans++)
                {
                ...
                cout << endl
                     << "\033[31mWrong Input! You cannot enter repeated numbers!\033[0m" << endl;
                ;
            }
            while (true)
            { // 第二組輸入謎底
                cout << "\033[34mGroup2 please input " << digit << " digits(split by space): \033[0m";
                for (int ans = 0; ans < digit; ans++)
                {
